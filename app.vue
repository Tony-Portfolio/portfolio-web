...
//         const x = e.clientX - 200; // Subtract half the width of the circle
//         const y = e.clientY - 200; // Subtract half the height of the circle
...
<template>
    <div class="dark:bg-slate-900 bg-white">
        ...
        <!-- <div class="fixed bottom-4 right-4">
            <button
                class="bg-white p-2 rounded-full shadow-lg focus:outline-none"
                @click="toggleTheme"
            >
                <span v-if="!enabled">
                    <svg
